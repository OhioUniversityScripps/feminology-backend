...
ath.intl = {
	...
	en_us: {
		message: 'To add Feminology to the home screen: tap %icon and then <strong>%action</strong>.',
...
ath.defaults = {
	...
	lifespan: 10,				// life of the message in seconds
	displayPace: 720,		// 12 Hours	// minutes before the message is shown again (0: display every time, default 24 hours)
